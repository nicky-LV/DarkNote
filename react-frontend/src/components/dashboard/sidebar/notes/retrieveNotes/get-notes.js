...
import {RetrieveNotesAPI} from "../../../../API/notes/retrieve-notes";
import {Options} from '../options/options'
import {Button} from "react-bootstrap";
import '../../../../../static/css/dashboard/notes/get-notes.css';
    ...
    useEffect( () => {
            ...
            RetrieveNotesAPI(props.notebookSlug)
                .then( res => {
                        ...
                        setNoteList(noteList) // updates the list of notes, as there was a change.
